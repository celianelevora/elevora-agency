...
const FAQS = [
  {
    ...
    a: "Nos sites vitrines démarrent à 625 € HT. Le tarif final dépend du nombre de pages, des fonctionnalités demandées et du niveau de design. Pour un outil de gestion sur mesure, nous établissons un devis personnalisé après un premier échange. Dans tous les cas, le prix annoncé est ferme.",
  },
  {
