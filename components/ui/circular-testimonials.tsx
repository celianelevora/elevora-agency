...
export const CircularTestimonials = ({
  ...
  const colorDesignation = colors.designation ?? "#6B6B6B";
  const colorTestimony = colors.testimony ?? "#2D2D2D";
  const colorArrowBg = colors.arrowBackground ?? "#1B4F8A";
  const colorArrowFg = colors.arrowForeground ?? "#F5F0E8";
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "#2B6CC4";
